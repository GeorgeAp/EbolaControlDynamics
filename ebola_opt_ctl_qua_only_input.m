function ebola_opt_ctl_qua_only_input()
clc, clear,close all hidden
    
beta=0.112;epsilon=0.029;delta=0.083;rho=0.1;omega=0.073;sigma=1.7;meu=0.20;alpha=2.57;omegaI=0.10;omegaQ=0.50;
T=20;S0=16;E0=0;I0=1;Q0=0;R0=0;c2=0.4;
% M=[1:21]';
y1=ebola_opt_ctl_qua_only(beta,epsilon,delta,rho,omega,sigma,meu,alpha,omegaI,omegaQ,T,S0,E0,I0,Q0,R0,c2);
